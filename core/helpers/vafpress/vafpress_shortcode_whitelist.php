<?php
function wpurp_shortcode_generator_grids_by_date()
{
    if( function_exists( 'wpupg_shortcode_generator_grids_by_date' ) ) {
        return wpupg_shortcode_generator_grids_by_date();
    } else {
        return array();
    }
}
...
VP_Security::instance()->whitelist_function('wpurp_shortcode_generator_grids_by_date');
